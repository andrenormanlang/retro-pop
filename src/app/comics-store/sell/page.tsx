...
const validationSchema = z.object({
	...
	price: z.preprocess(
		...
		z.number().positive({ message: "Price is required must be positive" })
	),
	stock: z.preprocess(
		(val) => parseFloat(val as string),
		z.number().positive({ message: "Stock is required and must be positive" })
	),
	pages: z.preprocess(
		(val) => parseInt(val as string),
		z.number().positive({ message: "Pages are required and must be positive" })
	),
